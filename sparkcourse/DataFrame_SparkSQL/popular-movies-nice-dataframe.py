...
nameDict = spark.sparkContext.broadcast(loadMovieNames())#loadMovieNames: 번호:영화제목 키벨류값의 딕셔너리 형태로 반환
...
#func.udf: 파이썬  사용자 정의 함수를 spark udf로 변환하는 함수
